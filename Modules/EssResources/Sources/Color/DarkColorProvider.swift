//
//  DarkColorProvider.swift
//  EssResources
//
//  Created by Pavlo Boiko on 7/3/19.
...
fileprivate struct Constants {
    static var appLightGray = #colorLiteral(red: 0.07450980392, green: 0.1019607843, blue: 0.137254902, alpha: 1)//RGB(19, 26, 35)
    static var appLigntLightGray = #colorLiteral(red: 0.07450980392, green: 0.1019607843, blue: 0.137254902, alpha: 1)//RGB(19, 26, 35)
    static var appDarkGray = #colorLiteral(red: 0.07450980392, green: 0.1019607843, blue: 0.137254902, alpha: 1)//RGB(19, 26, 35)
    ...
    static var appWhiteColor = #colorLiteral(red: 0.3843137255, green: 0.431372549, blue: 0.4941176471, alpha: 1) //RGB(98, 110, 126)
    static var appDarkTextColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0) // .white
    static var appSemiDarkColor = #colorLiteral(red: 0.5764705882, green: 0.6431372549, blue: 0.7490196078, alpha: 1) //RGB(147, 164, 191)
    ...
    static var appWhiteWithLightBlue = #colorLiteral(red: 0.07450980392, green: 0.1019607843, blue: 0.137254902, alpha: 1)//RGB(19, 26, 35)
...
public struct DarkColorProvider: AppColorInterface {
    public init() {}
    ...
    // MARK: - TopAlert
    public var alertInfoColor: UIColor = Constants.appLightGreen
    public var alertErrorColor: UIColor = Constants.appRedColor
}
